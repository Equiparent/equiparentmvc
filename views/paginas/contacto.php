    ...
    <legend>Contáctanos llenando todos los campos</legend>
      <div class="contenedor-campos">
        ...
        <div class="campo">
          ...
          <input class="input-text" type="text" placeholder="Tu Teléfono" id="telefono" name="contacto[telefono]">
        </div>
      ...
      <div class="campo">
        <label class="campo__label" for="mensaje">Mensaje</label>
          ...
          <input type="submit" value="Enviar" class="boton boton-verde-claro">
  </main>
